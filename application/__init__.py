...
app.config['SECURITY_PASSWORD_SALT'] = os.environ['password-salt']
...
app.config['MAIL_USERNAME'] = os.environ['mail-username']
app.config['MAIL_PASSWORD'] = os.environ['mail-password']
